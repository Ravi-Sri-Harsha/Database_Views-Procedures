...
FROM CMDB_V10.cdm_nt_1 nt
WHERE 
nt.A_DATA_SOURCE='HPE_Component_Dataload: DS_HPE_Component_Dataload_Import topology from Excel Workbook' AND
...
WHERE 
unix.A_DATA_SOURCE='HPE_Component_Dataload: DS_HPE_Component_Dataload_Import topology from Excel Workbook' AND
